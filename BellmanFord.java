...
public static void BellmanFordEvaluation(int Source,int
matrix[][],int d[],int numvertices){
int MAX_VALUE=999;
...
{
System.out.println("The distance from "+" "+Source+" "+"to"+" "+vertices+" "+"is :"+d[vertices]);
}
}
